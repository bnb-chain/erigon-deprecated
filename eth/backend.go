...
func (s *Ethereum) Start() error {
	...
	go stages2.StageLoop(s.sentryCtx, s.chainDB,
		s.stagedSync, s.sentriesClient.Hd, s.notifications, s.sentriesClient.UpdateHead, s.waitForStageLoopStop, s.config.Sync.LoopThrottle)
